...
public final class LRIGA_R1_YuzukiRuby extends Card {

    public LRIGA_R1_YuzukiRuby()
    {
        setImageSets("WXDi-P10-024");

        setOriginalName("遊月・ルビー");
        setAltNames("ユヅキルビー Yuzuki Rubii");
        setDescription("jp",
                "@E：対戦相手のパワー10000以下のシグニ１体を対象とし、それをバニッシュする。"
        );

        setName("en", "Yuzuki Ruby");
        setDescription("en",
                "@E: Vanish target SIGNI on your opponent's field with power 10000 or less."
        );
        
        setName("en_fan", "Yuzuki Ruby");
        setDescription("en_fan",
                "@E: Target 1 of your opponent's SIGNI with power 10000 or less, and banish it."
        );

		setName("zh_simplified", "游月·红宝石");
