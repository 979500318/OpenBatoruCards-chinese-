...
public final class SIGNI_X2_ServantD4 extends Card {
    
    public SIGNI_X2_ServantD4()
    {
        setImageSets("WDK01-018", "WDK11-018","WDK16-18", "SPK10-03-T");
        
        setOriginalName("サーバント　Ｄ４");
        setAltNames("サーバントディーフォー Saabanto Dii Foo Four");
        setDescription("jp",
                "~@" +
                "@C：[[マルチエナ]]" +
