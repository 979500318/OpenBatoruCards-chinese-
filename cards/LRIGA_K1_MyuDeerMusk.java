...
public final class LRIGA_K1_MyuDeerMusk extends Card {

    public LRIGA_K1_MyuDeerMusk()
    {
        setImageSets("WXDi-P13-039");

        setOriginalName("ミュウ　－　ジャコウ");
        setAltNames("ミュウジャコウ Myuu Jakou");
        setDescription("jp",
