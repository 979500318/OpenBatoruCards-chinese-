...
public final class LRIGA_K1_UrithMad extends Card {

    public LRIGA_K1_UrithMad()
    {
        setImageSets("WXDi-P10-029");

        setOriginalName("ウリス・マッド");
        setAltNames("ウリスマッド Urisu Maddo");
        setDescription("jp",
                "@E：あなたのデッキの上からカードを２枚トラッシュに置く。その後、あなたのトラッシュから#Gを持たない、共通するクラスを持つシグニ２枚を対象とし、それらを手札に加える。"
        );

        setName("en", "Urith Mad");
        setDescription("en",
