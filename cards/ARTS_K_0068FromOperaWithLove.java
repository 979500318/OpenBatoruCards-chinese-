...
public final class ARTS_K_0068FromOperaWithLove extends Card {
    ...
    public ARTS_K_0068FromOperaWithLove()
    {
        ...
        setDescription("zh_simplified", 
                ...
                "$$1 从你的牌组上面把5张牌放置到废弃区。这个方法把<<ブルアカ>>牌放置到废弃区的场合，这个回合，下一次你受到伤害的场合，作为替代，不会受到伤害。\n" +
                "$$2 从你的废弃区选1张精灵，那张牌加入手牌。\n" +
                "$$3 对战对手的精灵1只作为对象，这个回合，当下一次其攻击时，直到回合结束时为止，其的力量依据你的废弃区的<<ブルアカ>>牌的数量，每有1张就-2000。\n" +
