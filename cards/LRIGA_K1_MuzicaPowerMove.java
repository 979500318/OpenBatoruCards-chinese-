...
public final class LRIGA_K1_MuzicaPowerMove extends Card {
    
    public LRIGA_K1_MuzicaPowerMove()
    {
        setImageSets("WXDi-P02-032");
        
        setOriginalName("ムジカ／／パワームーブ");
        setAltNames("ムジカパワームーブ Mujika Pawaa Muubu");
        setDescription("jp",
                "@E：対戦相手のシグニ１体を対象とし、ターン終了時まで、それのパワーを－8000する。"
        );
        
        setName("en", "Muzica//Power Move");
        setDescription("en",
                "@E: Target SIGNI on your opponent's field gets --8000 power until end of turn."
        );
        
        setName("en_fan", "Muzica//Power Move");
        setDescription("en_fan",
                "@E: Target 1 of your opponent's SIGNI, and until end of turn, it gets --8000 power."
        );
        
		setName("zh_simplified", "穆希卡//力移");
