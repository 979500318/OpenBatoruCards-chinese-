...
public final class ARTS_G_FollowSuit extends Card {

    public ARTS_G_FollowSuit()
    {
        setImageSets("WX24-D4-07");

        setOriginalName("付洋雷同");
        setAltNames("ビガーウェーブ Bigaa Weebu Bigger Wave");
        setDescription("jp",
                "対戦相手のパワー8000以下のシグニ１体を対象とし、それをエナゾーンに置く。\n" +
                "&E４枚以上@0代わりに対戦相手のシグニ１体を対象とし、それをエナゾーンに置く。"
        );

        setName("en", "Follow Suit");
        setDescription("en",
