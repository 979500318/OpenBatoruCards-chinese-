...
public final class SIGNI_W2_OseHolyDevil extends Card {
    
    public SIGNI_W2_OseHolyDevil()
    {
        setImageSets("WXDi-P06-048");
        
        setOriginalName("聖魔　オセ");
        setAltNames("セイマオセ Seima Ose");
        setDescription("jp",
                "~#：あなたのデッキの上からカードを５枚見る。その中からカードを３枚まで手札に加え、残りを好きな順番でデッキの一番下に置く。"
        );
        
        setName("en", "Ose, Blessed Evil");
        setDescription("en",
