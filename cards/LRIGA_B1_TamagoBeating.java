...
public final class LRIGA_B1_TamagoBeating extends Card {
    
    public LRIGA_B1_TamagoBeating()
    {
        setImageSets("WXDi-P02-025");
        
        setOriginalName("タマゴ＝ビーティング");
        setAltNames("タマゴビーティング Tamago Biitingu");
        setDescription("jp",
                "@E：対戦相手のレベル１のシグニ１体を対象とし、それをデッキの一番下に置く。"
        );
        
        setName("en", "Tamago =Beating=");
        setDescription("en",
                "@E: Put target level one SIGNI on your opponent's field on the bottom of its owner's deck."
        );
        
        setName("en_fan", "Tamago-Beating");
        setDescription("en_fan",
                "@E: Target 1 of your opponent's level 1 SIGNI, and put it on the bottom of their deck."
        );
        
		setName("zh_simplified", "玉子=拍拍");
