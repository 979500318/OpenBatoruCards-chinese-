...
public final class LRIGA_W2_AssistLizeLevel2Dash extends Card {
    
    public LRIGA_W2_AssistLizeLevel2Dash()
    {
        setImageSets("WXDi-P00-025");
        
        setOriginalName("【アシスト】リゼ　レベル２’");
        setAltNames("アシストリゼレベルニダッシュ Ashisuto Rize Reberu Ni Dasshu Dash Assist Lize");
        setDescription("jp",
