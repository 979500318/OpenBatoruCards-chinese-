...
public final class SIGNI_G2_HanumanVerdantAngel extends Card {
    
    public SIGNI_G2_HanumanVerdantAngel()
    {
        setImageSets("WXDi-P06-074");
        
        setOriginalName("翠天　ハヌマーン");
        setAltNames("スイテンハヌマーン Suiten Hanumaan");
        setDescription("jp",
                "~#：あなたのデッキの上からカードを５枚見る。その中からカードを３枚まで手札に加え、残りを好きな順番でデッキの一番下に置く。"
        );
        
        setName("en", "Hanuman, Jade Angel");
        setDescription("en",
        ...
        setName("en_fan", "Hanumān, Verdant Angel");
