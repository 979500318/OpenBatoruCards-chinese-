...
public final class SIGNI_W2_AlpacaPhantomBeast extends Card {

    public SIGNI_W2_AlpacaPhantomBeast()
    {
        setImageSets("WX24-P1-056");

        setOriginalName("幻獣　アルパカ");
        setAltNames("ゲンジュウアルパカ Genjuu Arupaka");
        setDescription("jp",
                "@C：このシグニはパワーが10000以上であるかぎり、【シュート】を得る。" +
                "~#：あなたのデッキの上からカードを３枚見る。その中からシグニ１枚を公開し手札に加えるか場に出し、残りを好きな順番でデッキの一番下に置く。"
        );

        setName("en", "Alpaca, Phantom Beast");
        setDescription("en",
                "@C: As long as this SIGNI's power is 10000 or more, this SIGNI gains [[Shoot]]." +
		...
		setName("zh_simplified", "幻兽 羊驼");
        setDescription("zh_simplified", 
                "@C :这只精灵的力量在10000以上时，得到[[击落]]。" +
    ...
    public class IndexedInstance extends Card.IndexedInstance
    {
        ...
        {
            return getPower().getValue() >= 10000 ? ConditionState.OK : ConditionState.BAD;
        }
