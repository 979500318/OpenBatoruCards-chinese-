...
public final class ARTS_G_PrayerForDivineBlessings extends Card {
    ...
    public class IndexedInstance extends Card.IndexedInstance
    {
        public IndexedInstance(int cardId)
        {
            ...
            arts.setReductionCost(new TrashCost(new TargetFilter().own().ARTS().withColor(CardColor.GREEN).except(getCardIndex()).fromLocation(CardLocation.DECK_LRIG)), Cost.color(CardColor.GREEN, 3));
        }
