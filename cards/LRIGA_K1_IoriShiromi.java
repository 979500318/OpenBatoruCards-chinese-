...
public final class LRIGA_K1_IoriShiromi extends Card {

    public LRIGA_K1_IoriShiromi()
    {
        setImageSets("WXDi-CP02-045");

        setOriginalName("銀鏡イオリ");
        setAltNames("シロミイオリ Shiromi Iori");
        setDescription("jp",
                "@E：対戦相手のシグニ１体を対象とし、ターン終了時まで、それのパワーを－8000する。"
        );

        setName("en", "Shiromi Iori");
        setDescription("en",
                "@E: Target SIGNI on your opponent's field gets --8000 power until end of turn."
        );
        
        setName("en_fan", "Iori Shiromi");
        setDescription("en_fan",
                "@E: Target 1 of your opponent's SIGNI, and until end of turn, it gets --8000 power."
        );

		setName("zh_simplified", "银镜伊织");
