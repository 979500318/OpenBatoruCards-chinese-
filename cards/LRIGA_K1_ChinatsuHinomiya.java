...
public final class LRIGA_K1_ChinatsuHinomiya extends Card {

    public LRIGA_K1_ChinatsuHinomiya()
    {
        setImageSets("WXDi-CP02-046");

        setOriginalName("火宮チナツ");
        setAltNames("ヒノミヤチナツ Hinomiya Chinatsu");
        setDescription("jp",
                "@E：あなたのデッキの上からカードを２枚トラッシュに置く。その後、あなたのトラッシュから#Gを持たない、共通するクラスを持つシグニ２枚を対象とし、それらを手札に加える。"
        );

        setName("en", "Hinomiya Chinatsu");
        setDescription("en",
        ...
        setName("en_fan", "Chinatsu Hinomiya");
    ...
    public class IndexedInstance extends Card.IndexedInstance
    {
        ...
        {
            return pickedCards.size() == 2 && pickedCards.get(0).getIndexedInstance().getSIGNIClass().matches(pickedCards.get(1).getIndexedInstance().getSIGNIClass());
        }
    }
}
