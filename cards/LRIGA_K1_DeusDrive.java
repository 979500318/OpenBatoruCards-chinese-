...
public final class LRIGA_K1_DeusDrive extends Card {
    
    public LRIGA_K1_DeusDrive()
    {
        setImageSets("WXDi-D07-006");
        
        setOriginalName("デウスドライブ");
        setAltNames("Deusu Doraibu");
        setDescription("jp",
                "@E：対戦相手のレベル２以下のシグニ１体を対象とし、それをバニッシュする。"
        );
        
        setName("en", "Deus Drive");
        setDescription("en",
                "@E: Vanish target level two or less SIGNI on your opponent's field."
        );
        
        setName("en_fan", "Deus Drive");
        setDescription("en_fan",
                "@E: Target 1 of your opponent's level 2 or lower SIGNI, and banish it."
        );
        
		setName("zh_simplified", "迪乌斯启动");
