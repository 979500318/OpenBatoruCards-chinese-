...
public final class LRIGA_W2_TamaShield extends Card {
    
    public LRIGA_W2_TamaShield()
    {
        setImageSets("WXDi-P08-024");
        
        setOriginalName("タマ・しーるど");
        setAltNames("タマシールド Tama Shiirudo");
        setDescription("jp",
                "@E：対戦相手のシグニ１体を対象とし、ターン終了時まで、それは@>@C：アタックできない。@@を得る。\n" +
                "@E @[手札を２枚捨てる]@：対戦相手のシグニ１体を対象とし、ターン終了時まで、それは能力を失う。\n" +
                "@E %W %X %X：対戦相手のレベル１のシグニ１体を対象とし、それを手札に戻す。"
        );
        
        setName("en", "Tama Shield");
        setDescription("en",
                "@E: Target SIGNI on your opponent's field gains@>@C: This SIGNI cannot attack.@@until end of turn.\n" +
                "@E @[Discard two cards]@: Target SIGNI on your opponent's field loses its abilities until end of turn.\n" +
                "@E %W %X %X: Return target level one SIGNI on your opponent's field to its owner's hand."
        );
        
        setName("en_fan", "Tama Shield");
        setDescription("en_fan",
                "@E: Target 1 of your opponent's SIGNI, and until end of turn, it gains:" +
                "@>@C: Can't attack.@@" +
                "@E @[Discard 2 cards from your hand]@: Target 1 of your opponent's SIGNI, and until end of turn, it loses its abilities.\n" +
                "@E %W %X %X: Target 1 of your opponent's level 1 SIGNI, and return it to their hand."
        );
        
		setName("zh_simplified", "小玉·圣盾");
        setDescription("zh_simplified", 
                "@E :对战对手的精灵1只作为对象，直到回合结束时为止，其得到\n" +
                "@>@C :不能攻击。@@\n" +
                "@E 手牌2张舍弃:对战对手的精灵1只作为对象，直到回合结束时为止，其的能力失去。\n" +
                "@E %W%X %X:对战对手的等级1的精灵1只作为对象，将其返回手牌。\n"
        );
