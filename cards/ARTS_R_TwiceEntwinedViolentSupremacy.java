...
public final class ARTS_R_TwiceEntwinedViolentSupremacy extends Card {
    ...
    public ARTS_R_TwiceEntwinedViolentSupremacy()
    {
        ...
        setName("es", "Doble entrelazo de la supremacia violenta");
        setDescription("es",
                "Selecciona 1 SIGNI oponente con 8000 o menos poder y desvánecela.\n" +
                "&E4 o mas@0 En cambio, selecciona 1 SIGNI oponente y desvánecela."
        );
