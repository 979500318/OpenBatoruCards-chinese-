...
public final class LRIGA_R1_ExGazer extends Card {
    
    public LRIGA_R1_ExGazer()
    {
        setImageSets("WXDi-P04-017");
        
        setOriginalName("エクスゲイザー");
        setAltNames("Ekusu Geizaa");
        setDescription("jp",
                "@E：対戦相手のパワー10000以下のシグニを１体を対象とし、それをバニッシュする。"
        );
