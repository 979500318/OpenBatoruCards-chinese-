...
public final class ARTS_K_BlackWish extends Card {
    ...
    public class IndexedInstance extends Card.IndexedInstance
    {
        public IndexedInstance(int cardId)
        {
            ...
            arts.setReductionCost(new TrashCost(new TargetFilter().own().ARTS().withColor(CardColor.BLACK).except(getCardIndex()).fromLocation(CardLocation.DECK_LRIG)), Cost.color(CardColor.BLACK, 3));
        }
