...
public final class ARTS_K_BlackSpark extends Card {

    public ARTS_K_BlackSpark()
    {
        setImageSets("WX25-P1-045");

        setOriginalName("ブラック・スパーク");
        setAltNames("ブラックスパーク Burakku Supaaku");
        setDescription("jp",
                "対戦相手のレベル２以下のシグニ１体を対象とし、それをバニッシュする。"
        );

        setName("en", "Black Spark");
        setDescription("en",
                "Target 1 of your opponent's level 2 or lower SIGNI, and banish it."
        );

		setName("zh_simplified", "漆黑·闪光");
