...
public final class ARTS_R_BurningDesireForFieryTruths extends Card {
    ...
    public class IndexedInstance extends Card.IndexedInstance
    {
        public IndexedInstance(int cardId)
        {
            ...
            arts.setReductionCost(new TrashCost(new TargetFilter().own().ARTS().withColor(CardColor.RED).except(cardId).fromLocation(CardLocation.DECK_LRIG)), Cost.color(CardColor.RED, 3));
        }
