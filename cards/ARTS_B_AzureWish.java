...
public final class ARTS_B_AzureWish extends Card {
    ...
    public class IndexedInstance extends Card.IndexedInstance
    {
        public IndexedInstance(int cardId)
        {
            ...
            arts.setReductionCost(new TrashCost(new TargetFilter().own().ARTS().withColor(CardColor.BLUE).except(cardId).fromLocation(CardLocation.DECK_LRIG)), Cost.color(CardColor.BLUE, 3));
        }
