...
public final class SIGNI_B2_IoliteNaturalStone extends Card {
    
    public SIGNI_B2_IoliteNaturalStone()
    {
        setImageSets("WXDi-P06-065", "SPDi38-04");
        
        setOriginalName("羅石　アイオライト");
        setAltNames("ラセキアイオライト Raseki Aioraito");
        setDescription("jp",
                "~#：あなたのデッキの上からカードを５枚見る。その中からカードを３枚まで手札に加え、残りを好きな順番でデッキの一番下に置く。"
        );
        
        setName("en", "Iolite, Natural Crystal");
        setDescription("en",
        ...
        setName("en_fan", "Iolite, Natural Stone");
