...
public final class SIGNI_X4_ServantQ4 extends Card {

    public SIGNI_X4_ServantQ4()
    {
        setImageSets("WXK01-119", "WXK08-097", "SPK10-01-T");

        setOriginalName("サーバント　Ｑ４");
        setAltNames("サーバントキューフォー Saabanto Kyuu Foo Four");
        setDescription("jp",
                "~@" +
                "@C：【マルチエナ】" +
