...
public final class SIGNI_G2_KobolPhantomApparition extends Card {

    public SIGNI_G2_KobolPhantomApparition()
    {
        setImageSets("WXK01-096");

        setOriginalName("幻怪　コーボル");
        setAltNames("ゲンカイコーボル Genkai Kooboru");
        setDescription("jp",
                "@C：このシグニが中央のシグニゾーンにあるかぎり、このシグニのパワーは＋2000される。\n" +
                "@C：このシグニが左のシグニゾーンにあるかぎり、このシグニは対戦相手のシグニの効果によってバニッシュされない。"
        );

        setName("en", "Kobol, Phantom Apparition");
        setDescription("en",
                "@C: As long as this SIGNI is in the center SIGNI zone, this SIGNI gets +2000 power.\n" +
                "@C: As long as this SIGNI is in the left SIGNI zone, this SIGNI can't be banished by the effects of your opponent's SIGNI."
        );

		setName("zh_simplified", "幻怪 科博尔德");
        setDescription("zh_simplified", 
                "@C :这只精灵在中央的精灵区时，这只精灵的力量+2000。\n" +
                "@C :这只精灵在左侧的精灵区时，这只精灵不会因为对战对手的精灵的效果破坏。\n"
        );
