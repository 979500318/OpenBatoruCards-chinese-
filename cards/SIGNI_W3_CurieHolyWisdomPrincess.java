...
public final class SIGNI_W3_CurieHolyWisdomPrincess extends Card {
    ...
    public SIGNI_W3_CurieHolyWisdomPrincess()
    {
        ...
        setDescription("zh_simplified", 
                "@U 你的攻击阶段开始时，可以把你的竖直状态的分身1只#D。然后，与这个方法#D的分身相同等级的对战对手的精灵1只作为对象，可以支付%X。这样做的场合，将其返回手牌。\n" +
                "@U 你的攻击阶段开始时，可以把你的竖直状态的分身1只#D。直到下一个对战对手的回合结束时为止，这只精灵得到[[暗影（与这个方法#D的分身相同等级的精灵）]]。\n"
        );
