...
public final class LRIGA_R1_HiranaStage extends Card {
    
    public LRIGA_R1_HiranaStage()
    {
        setImageSets("WXDi-P02-010");
        
        setOriginalName("ヒラナ＊ステージ");
        setAltNames("ヒラナステージ Hirana Suteeji");
        setDescription("jp",
                "@E：対戦相手のレベル２以下のシグニ１体を対象とし、それをバニッシュする。"
        );
        
        setName("en", "Hirana*On - Stage");
        setDescription("en",
                "@E: Vanish target level two or less SIGNI on your opponent's field."
        );
        
        setName("en_fan", "Hirana*Stage");
        setDescription("en_fan",
                "@E: Target 1 of your opponent's level 2 or lower SIGNI, and banish it."
        );
        
		setName("zh_simplified", "平和＊上演中");
