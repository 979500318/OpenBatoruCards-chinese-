...
public final class ARTS_R_BlazingHeatedStone extends Card {
    ...
    public ARTS_R_BlazingHeatedStone()
    {
        ...
        setName("es", "Flameante ardiente piedra");
        setDescription("es",
                "Selecciona 1 SIGNI oponente con 8000 o menos poder y desvánecela. Mira 4 cartas del tope de tu mazo y revela hasta 2 cartas rojas de entre ellas, añadelas a tu mano y pon el resto en el fondo de tu mazo en cualquier orden."
        );
