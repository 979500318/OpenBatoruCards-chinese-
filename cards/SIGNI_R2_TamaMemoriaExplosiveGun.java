...
public final class SIGNI_R2_TamaMemoriaExplosiveGun extends Card {
    ...
    public SIGNI_R2_TamaMemoriaExplosiveGun()
    {
        ...
        setDescription("zh_simplified", 
                "@U 当这只精灵攻击时，这只精灵的左侧或右侧有#D状态的<<ウェポン>>精灵的场合，对战对手的力量5000以下的精灵1只作为对象，可以支付%X。这样做的场合，将其破坏。\n" +
                "@U 当这只精灵攻击时，这只精灵的左侧或右侧有#D状态的<<アーム>>精灵的场合，从对战对手的能量区把不持有与对战对手的核心分身共通颜色的牌1张作为对象，可以支付%X。这样做的场合，将其放置到废弃区。\n"
        );
