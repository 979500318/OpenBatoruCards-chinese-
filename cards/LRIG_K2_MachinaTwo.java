...
public final class LRIG_K2_MachinaTwo extends Card {
    
    public LRIG_K2_MachinaTwo()
    {
        setImageSets("WXDi-P04-015");
        
        setOriginalName("マキナ・ツー");
        setAltNames("マキナツー Makina Tsuu");
        setDescription("jp",
                "@C：このカードが[[ソウル]]として付いているシグニは@>@U $T1：このシグニがアタックしたとき、対戦相手のレベル２以下のシグニ１体を対象とし、それをバニッシュする。@@を得る。"
        );
        
        setName("en", "Machina Two");
        setDescription("en",
                "@C: The SIGNI with this card attached to it as a [[Soul]] gains@>@U $T1: When this SIGNI attacks, vanish target level two or less SIGNI on your opponent's field."
        );
        
        setName("en_fan", "Machina Two");
        setDescription("en_fan",
                "@C: The SIGNI attached with this card as a [[Soul]] gains:" +
                "@>@U $T1: When this SIGNI attacks, target 1 of your opponent's level 2 or lower SIGNI, and banish it."
        );
        
		setName("zh_simplified", "玛琪娜·贰");
        setDescription("zh_simplified", 
                "@C :被这张牌作为[[灵魂]]附加的精灵得到\n" +
                "@>@U $T1 :当这只精灵攻击时，对战对手的等级2以下的精灵1只作为对象，将其破坏。@@\n"
        );
