...
public final class LRIGA_B1_MilulunSlash extends Card {

    public LRIGA_B1_MilulunSlash()
    {
        setImageSets("WXDi-P14-024");

        setOriginalName("ミルルン☆スラッシュ");
        setAltNames("ミルルンスラッシュ Mirurun Surasshu");
        setDescription("jp",
                "@E：対戦相手のレベル２以下のシグニ１体を対象とし、それをバニッシュする。"
        );

        setName("en", "Milulun ☆ Slash");
        setDescription("en",
                "@E: Vanish target level two or less SIGNI on your opponent's field."
        );
        
        setName("en_fan", "Milulun☆Slash");
        setDescription("en_fan",
                "@E: Target 1 of your opponent's level 2 or lower SIGNI, and banish it."
        );

		setName("zh_simplified", "米璐璐恩☆斩击");
